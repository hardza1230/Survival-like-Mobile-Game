...
const CHANGELOG = [
  ...
  { v:'2.97.0', date:'2026-09-19', title:'สอนเล่นแบบ freeze-time + ด่าน 1 ง่ายขึ้น + ล็อกความยาก', items:[
    ...
    'ไม่มีบทพูดกับตัวเองซ้อนตอนสอนแล้ว',
    'ด่าน 1 / ผู้เล่นใหม่ ศัตรูเลือดน้อยลง (ตีน้อยครั้งลง)',
    'ระดับความยากต้องผ่านระดับก่อนหน้าก่อนถึงปลดล็อก (ที่ยังไม่ผ่าน = 🔒)',
  ]},
  ...
  { v:'2.78.0', date:'2026-09-17', title:'Mint → Frost Lance + Flicker faster + Cocoa regen', items:[
    ...
    'เอาลูกบอลโคจรออก (ซ้ำกับออร่างาดำ) — มิ้นต์เป็นสายพุ่งหอกชัดเจน',
    'Flicker Strike (โกโก้) คูลดาวน์ 6.5→4.5 วิ · โกโก้ regen เลือด 0.35→0.75/วิ',
  ]},
  ...
  { v:'2.76.0', date:'2026-09-17', title:'Mint ice balls (start 2) + Evo shards', items:[
    ...
    'ใช้ texture ลูกฟองกลมชั่วคราว — พอมีอาร์ตจริง (proj_iceball) จะสลับให้อัตโนมัติ' ] },
  ...
  { v:'2.46.0', date:'2026-09-16', title:'All Characters Go Character-First', items:[
    ...
    'พักตัวละครเบอร์รี่คอร์ไว้ก่อน (นำออกจากหน้าเลือก) — เซฟที่เลือกเบอร์รี่จะคืนเป็นโมโม่อัตโนมัติ' ] },
  ...
  { v:'2.39.0', date:'2026-09-14', title:'Roguelike Health Economy', items:[
    ...
    'ตัวละครทุกตัวมีค่ารีเจนพื้นฐานเฉพาะตัว พร้อมเพดานรีเจนตามเปอร์เซ็นต์ HP สูงสุดเพื่อคุมสมดุลช่วงท้ายเกม' ] },
  { v:'2.38.0', date:'2026-09-13', title:'Berry Core Joins the Roster', items:[
    'เพิ่ม Berry Core เป็นตัวละครที่ 6 แยกจาก Momo พร้อม Character Card, action sheet 8 ท่า และ run cycle 12 เฟรม',
    'เพิ่มปืนแกนแยมเป็นอาวุธประจำตัวสายระเบิดหนัก และ Unique Jam Overdrive ยิงล็อกเป้าเป็นชุดต่อเนื่อง',
    'เพิ่ม Combat Profile และผังพรสวรรค์เฉพาะตัว พร้อมคงอาร์ตและความสามารถเดิมของ Momo ทุกส่วน' ] },
  { v:'2.37.0', date:'2026-09-13', title:'Chapter 1 · Dynamic Wave Missions', items:[
    'เพิ่มภารกิจสุ่มประจำเวฟใน Chapter 1: เอาชีวิตรอด, ล่า Elite เป้าหมาย, ทำลายแกนคำสาป และยึดพื้นที่',
    'แต่ละด่านสุ่มใช้ภารกิจครบทั้งสี่แบบโดยไม่ซ้ำในรันเดียว พร้อม HUD ความคืบหน้า ลูกศรนำทาง และโบนัส Sugar',
    'ภารกิจใช้วัตถุและเอฟเฟกต์แบบเบาสำหรับมือถือ พร้อม cleanup ครบเมื่อจบเวฟ ออกจากด่าน หรือเข้าสู้บอส' ] },
  { v:'2.36.2', date:'2026-09-13', title:'Fix Boss Zoom (Really Zooms) + Escort Tuning', items:[
    'แก้ให้กล้องซูมออกจริงตอนสู้บอส/มินิบอสด้วย lerp ต่อเฟรม · ซูมออกมากขึ้น (บอส ×0.58 · มินิ ×0.68)',
    'บริวารที่บอสเรียกมีขนาดเล็กกว่ามินิบอสจริงชัดเจน พร้อมเพิ่ม HP และดาเมจเล็กน้อย' ] },
  { v:'2.36.1', date:'2026-09-13', title:'Wider Boss Zoom + Mini-boss Cutscene', items:[
    'มินิบอสมี Cutscene สั้น ๆ ตอนโผล่: กล้องแพนไปเผยตัว วาบจอและเขย่า ก่อนกลับมาตามผู้เล่น',
    'แก้ให้มินิบอสเข้าโหมด mini จริง เพื่อให้ HUD, กล้อง และการไหลของลูกน้องทำงานถูกต้อง' ] },
  ...
  { v:'2.35.2', date:'2026-09-13', title:'Livelier Loading Screen', items:[
    'หน้าโหลดมีลูกกวาดลอย + แสงเรืองใต้สตรอว์เบอร์รี ให้ดูมีชีวิตขึ้น',
    'รองรับ safe area บนอุปกรณ์มือถือและคงขั้นตอนโหลดเดิม' ] },
  ...
  { v:'2.35.0', date:'2026-09-13', title:'Chapter 2 · Fermented Canopy', items:[
    ...
    'เพิ่มต้นแบบฉาก 2.5D แบบเบาสำหรับมือถือ: parallax สามชั้น หมอกลอย foreground leaves และ perspective scale โดยไม่เปลี่ยนระบบควบคุม',
    'เพิ่มภาพปก พื้นด่าน prop atlas และ action sheet ใหม่ พร้อม validation สำหรับ Chapter 2 assets' ] },
  { v:'2.34.0', date:'2026-09-13', title:'Crown Oven Reborn', items:[
    'สร้าง The Great Hunger ใหม่เป็น Cosmic Sovereign พร้อม action sheet 8 ท่าและ pose ที่ผูกกับการโจมตี/เปลี่ยนเฟส/พ่ายแพ้จริง',
    'แทนมอนสเตอร์ด่าน 5 เดิมครบ 5 บทบาทด้วย Void Crumb, Crown Ripper, Banquet Eye, Maw Truffle และ Royal Oven Sentinel',
    'สร้างมินิบอส Banquet Executioner ใหม่ พร้อม animation, hitbox และภาพพ่ายแพ้เฉพาะตัว',
    'คงระบบบอส 4 เฟสและความเป็นอมตะระหว่างเปลี่ยนเฟส พร้อมเพิ่ม regression validation สำหรับ Stage 5 assets' ] },
  { v:'2.33.0', date:'2026-09-13', title:'Stage 3–4 Boss Rework + Endgame', items:[
    'ด่าน 3–4 มีพร็อพห้องเฉพาะ บอส action sheet 8 ท่า และแพตเทิร์นเฉพาะธีมพร้อม telegraph/phase pose',
    'เพิ่ม Endgame หลัง Mastery ครบ: Midnight Kitchen Endless, บอสลับทุก 3 รอบ, checkpoint Sugar และอันดับในเครื่อง',
    'เพิ่ม Ascension ที่เก็บตัวละคร/Gear/Rank พร้อมโบนัสถาวร และเพิ่มไอเทมดรอป Common/Rare/Epic กับหน้าคัมภีร์ไอเทม',
    'เพิ่มตัวตรวจ regression สำหรับ sprite sheet, power curve, difficulty risk/reward และ Endless scaling' ] },
  ...
  { v:'2.32.0', date:'2026-09-12', title:'Illustrated Rewards', items:[
    ...
    'จบด่านให้เลือกกล่อง Sugar, Gear หรือ Fortune พร้อมผลรางวัลและแจ็กพอตต่างกัน' ] },
  ...
  { v:'2.31.0', date:'2026-09-12', title:'Boss Phase VFX & Gentle Shake', items:[
    ...
    'ลดแรงสั่นหน้าจอทั่วเกมเหลือ 45% และลดระยะเวลาลง 35% เพื่อลดอาการเวียนหัวบนมือถือ' ] },
...
const Cloud = {
  ...
  accountLabel(){ try{ if(this.isGoogle())return this.user.email||'บัญชี Google'; return this.user?'บัญชีชั่วคราว (เครื่องนี้)':'Not connected'; }catch(e){ return 'Not connected'; } },
...
class Game extends Phaser.Scene {
  ...
  create(){
    ...
    this.waveNodes=this.physics.add.group({maxSize:8});     // แกนคำสาปของภารกิจเวฟ (แยกจากวัตถุบอส)
  ...
  castJamOverdrive(dm,ul){
    ...
    this.showBanner('💗 Jam Overdrive Lv'+ul,barrels+' ลำกล้อง · '+salvos+' ชุดยิง · ล็อกเป้าอัตโนมัติ',950);Sfx.clear();
  }
  ...
  uiStageCard(cont,x,y,w,h,st,index,open,fn){
    ...
    const chapter=this.add.text(x+37,y+20,'ด่าน '+stageLabel,{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'10px',color:open?'#172014':'#ddd5e5'}).setOrigin(0.5);
  ...
  buildCookbook(){
    ...
    byChar.forEach(o=>{
      ...
      recs.forEach((c,i)=>{
        ...
        const sub=known?c.desc:('เก็บ '+(pas?pas.emoji+' '+pas.name:c.b)+' with weapon');
  ...
  buildSkillArchive(){
    ...
    drawTab(tabX,'⚔️ โจมตี '+Object.keys(SKILLDEFS).length,tab==='attack',()=>{this._skillArchiveTab='attack';this._skillArchivePage=0;this._skillArchiveSelected=null;this.buildSkillArchive();},0xf0a54a);
    drawTab(tabX+tabW+tabGap,'✨ พร '+Object.keys(PASSIVES).length,tab==='passive',()=>{this._skillArchiveTab='passive';this._skillArchivePage=0;this._skillArchiveSelected=null;this.buildSkillArchive();},0x66d3b3);
    drawTab(tabX+(tabW+tabGap)*2,'🎁 ไอเทม',tab==='items',()=>{this._skillArchiveTab='items';this._skillArchiveSelected=null;this.buildSkillArchive();},0xc9a3ff);
    ...
    nav(w/2-120,'‹ ก่อนหน้า',page>0,()=>{this._skillArchivePage--;this.buildSkillArchive();});nav(w/2+120,'Next ›',page<pages-1,()=>{this._skillArchivePage++;this.buildSkillArchive();});
    this.menu.setVisible(true);
  }
  buildItemCodex(top){
    const w=this.W,h=this.H,portrait=w<=h,rows=[
      ...
      ['🧲','แม่เหล็ก','Vacuums all EXP orbs on the field · save it for after a big clear',0x7fd0ff],
  ...
  buildDaily(){
    ...
    const state=d.challengeDone?'Completed ✓':unlocked?'Start Challenge':'🔒 ต้องปลดล็อกด่าน '+(spec.stage+1),cbg=this.add.graphics(),cby=y2+h2-40;cbg.fillStyle(d.challengeDone?0x315142:unlocked?0x8e4fc0:0x3a3341,1);cbg.fillRoundedRect(w/2-bw/2,cby-20,bw,40,13);const cbt=this.add.text(w/2,cby,state,{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'13px',color:d.challengeDone?'#a8f0c0':'#ffffff'}).setOrigin(0.5);this.menu.add([t2,name,detail,cbg,cbt]);
  ...
  tutorialPages(){
    return [
      ...
      {e:'⚔️',t:'Weapon auto-fires!',d:'ไม่ต้องกดยิง อาวุธประจำตัวโจมตีศัตรูที่ใกล้สุดให้อัตโนมัติ · หน้าที่เราคือหลบและเล็งทิศให้ดี'},
  ...
  drawTutorial(){
    ...
    const hint=this.add.text(w/2,h-24,last?'👆 แตะเพื่อเริ่มเล่น!':'Tap to continue  ›',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'13px',color:'#ffe08a'}).setOrigin(0.5);
  ...
  buildChapterSelect(){
    ...
    CHAPTERS.forEach((c,i)=>{const col=i%cols,row=Math.floor(i/cols),x=side+col*(cw+gap),y=top+row*(ch+gap),progressOpen=i===0||!!(Save.data.stageMastery||{})[4],open=!!c.ready&&progressOpen;
      ...
      const state=this.add.text(x+cw-13,y+ch/2,open?'เข้าเล่น  ▶':c.ready?'Clear Chapter 1':'เร็ว ๆ นี้',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'10px',color:open?'#ffe08a':'#756d7e'}).setOrigin(1,0.5);
  ...
  buildStageSelect(){
    ...
    this.menu.removeAll(true); this.tapZones=[]; this._screenBg('เลือกด่าน · Chapter '+(chapterIndex+1),null,'chapter');
  ...
  buildUpgrade(){
    ...
    if(allMax) this._zone(pbx-bw/2,py,bw,ph,()=>{ const rew=Save.promote(); if(rew>=0){ Sfx.clear();
      if(this.showBanner)this.showBanner('⭐ สายใยแน่นแฟ้นขึ้น! '+rankName(Save.data.rank),'Memory and flavor become one · get 🍬 '+rew,2400); } this.buildMenuScreen(); });
    this.menu.setVisible(true);
  }
  buildRankPerks(){
  ...
  buildGearLandscape(){
    ...
    items.forEach((it,i)=>{const owned=Save.data.ownedGear.includes(it.id),equipped=Save.data.gear[sel]===it.id,lv=Save.gearLv(it.id),canEnh=it.enh&&lv<GEAR_ENH_MAX,ecost=gearEnhCost(lv),tl=TIER_LABEL[it.tier]||TIER_LABEL.common,nm=it.name+(it.tier==='rare'?' ⭐':it.tier==='epic'?' 💠':'')+(lv>0?' +'+lv:'');let label,color,fn;
      ...
      else if(equipped){label='ใส่อยู่ ✓';color='#ffd166';fn=null;}else if(owned){label='Equip';color='#8bd3a0';fn=()=>{Save.data.gear[sel]=it.id;Save.save();Sfx.select();this.buildMenuScreen();};}else{label='🔒 '+tl.name;color=tl.color;fn=null;}
  ...
  forgeLegend(){
    if((Save.data.shards||0)<LEGEND_FORGE_COST){ Sfx.select(); this.showBanner('🔩 เศษไม่พอ','Requires '+LEGEND_FORGE_COST+' shards (from duplicates)',1400); return; }
    ...
    this.showBanner('🌟 หลอมสำเร็จ!',(GEAR_SLOTS.find(s=>s.slot===it.slot).emoji)+' '+it.name+' · Legend',2000);
  ...
  rerollGearAffix(slot){
    ...
    if(!it||it.tier==='start'){ Sfx.select(); this.showBanner('✨ สุ่มไม่ได้','No affix-rollable item in this slot',1300); return; }
    if((Save.data.shards||0)<AFFIX_REROLL_COST){ Sfx.select(); this.showBanner('🔩 เศษไม่พอ','Requires '+AFFIX_REROLL_COST+' shards',1300); return; }
  ...
  applyCurrency(key){
    ...
    if(!it||it.tier==='start'){ Sfx.select(); this.showBanner('🧪 คราฟต์ไม่ได้','Nothing to craft in this slot',1300); return; }
    if(Save.currency(key)<1){ Sfx.select(); const c=currencyDef(key); this.showBanner((c?c.emoji:'🧪')+' no currency','หา '+(c?c.name:key)+' from stage drops first',1400); return; }
    ...
    let ok=false,msg='';
    switch(key){
      case 'transmute': if(rar==='common'){ rar='magic'; affs=[]; this._addAffixTo(affs,baseTier,'magic'); ok=true; msg='became Magic'; } else msg='ใช้ได้กับ Common เท่านั้น'; break;
      case 'alt':       if(rar==='magic'){ affs=[]; this._addAffixTo(affs,baseTier,'magic'); if(Math.random()<0.6)this._addAffixTo(affs,baseTier,'magic'); ok=true; msg='Reroll affixes'; } else msg='ใช้ได้กับ Magic เท่านั้น'; break;
      case 'regal':     if(rar==='magic'){ rar='rare'; this._addAffixTo(affs,baseTier,'rare'); ok=true; msg='became Rare!'; } else msg='ใช้ได้กับ Magic เท่านั้น'; break;
      case 'chaos':     if(rar==='rare'){ const n=Math.max(1,affs.length); affs=[]; for(let i=0;i<n;i++)this._addAffixTo(affs,baseTier,'rare'); ok=true; msg='Reroll all affixes'; } else msg='ใช้ได้กับ Rare เท่านั้น'; break;
      case 'exalt':     if(rar==='common'){ msg='Needs Magic/Rare first'; } else if(full){ msg='affixes full'; } else { ok=this._addAffixTo(affs,baseTier,rar); msg=ok?'เพิ่ม affix ใหม่!':'ไม่มีช่องว่าง'; } break;
      case 'divine':    if(affs.length){ for(const a of affs){ const d=affixDef(a.id); if(d&&d.tiers){ const band=d.tiers[(a.t||3)-1]||d.tiers[2]; a.v=band[0]+Math.floor(Math.random()*(band[1]-band[0]+1)); } } ok=true; msg='Reroll values (keep tier)'; } else msg='ไม่มี affix'; break;
      case 'annul':     if(affs.length){ affs.splice(Math.floor(Math.random()*affs.length),1); ok=true; msg='Remove 1 affix'; } else msg='ไม่มี affix'; break;
  ...
  buildBazaar(){
    ...
    if(tab==='buy'){
      ...
      this._rowBtn(y,40,'🔩','เศษอุปกรณ์ ×'+sh,'แปลงเศษทั้งหมดเป็น 🍬 (×2 ต่อเศษ)',sh>0?'Sell +🍬'+(sh*2):'ไม่มีเศษ',sh>0?'#8bd3a0':'#7a7088',sh>0?()=>this.bazaarSellShards():null); y+=46;
  ...
  bazaarBuyGear(id){ const it=GEAR_ALL.find(g=>g.id===id); if(!it)return; if(Save.data.ownedGear.includes(id))return; const cost=GEAR_BUY[it.tier]||200;
    if(!Save.spend(cost)){ Sfx.select(); this.showBanner('🍬 Sugar ไม่พอ','Requires '+cost+' Sugar',1300); return; }
  ...
  bazaarBuyCurrency(key,qty,cost){ if(!Save.spend(cost)){ Sfx.select(); this.showBanner('🍬 Sugar ไม่พอ','Requires '+cost+' Sugar',1300); return; }
  ...
  bazaarGambleGear(){ if(!Save.spend(180)){ Sfx.select(); this.showBanner('🍬 Sugar ไม่พอ','Requires 180 Sugar',1300); return; }
    ...
    this.buildBazaar(); }
  bazaarGambleCurrency(){ if(!Save.spend(120)){ Sfx.select(); this.showBanner('🍬 Sugar ไม่พอ','Requires 120 Sugar',1300); return; }
  ...
  openGachaReveal(){
    if(this._gachaBusy)return;if((Save.data.sugar||0)<GACHA_COST){Sfx.select();this.showBanner('🍬 Sugar ไม่พอ','Requires '+GACHA_COST+' Sugar to open the box',1300);return;}
  ...
  buildChapterDepth(i){
    ...
    // back terraces → mid canopy → foreground leaves: parallax ต่างกันแต่ไม่มี physics จึงเบาสำหรับมือถือ
  ...
  startStage(i){
    ...
    const stageNo=st.chapterStage?('C'+(st.chapter+1)+'-'+st.chapterStage):(i+1),_d=this.diffMul();this.stageTxt.setText(`ด่าน ${stageNo} · ${st.name} · ${_d.emoji}${_d.name}`);
    this.showBanner(`${st.emoji} ด่าน ${stageNo}: ${st.name}`, st.lore+' · ⚡ '+pg.rating+'/'+pg.recommended+' '+pg.label, 3000);
    this.updateWaveText();
  ...
  waveProfile(w){
    ...
    if(si===5){const canopy=[
      {name:'ต้นอ่อนหมัก',desc:'Ferment Sprout งอกจากความทรงจำที่ถูกเร่งฤดู',dur:50,interval:1.42,batch:2,max:30,pressureCap:0.22,types:['basic','basic','basic','basic','fast']},
      {name:'เถาวัลย์ล่าเหยื่อ',desc:'Vine Skipper พุ่งข้ามราก ขณะต้นอ่อนปิดทางถอย',dur:52,interval:1.04,batch:3,max:42,pressureCap:0.36,types:['fast','fast','dasher','basic','basic']},
      {name:'ผู้คุมสปอร์',desc:'Sporewarden Mantis ปิดเรือนยอดและเรียกต้นอ่อนจากพื้นหมัก',dur:0,interval:1.34,batch:3,max:36,pressureCap:0.42,types:['basic','fast','fast','shooter']},
      {name:'ฝนผลไม้พิษ',desc:'Spore Lantern ยิงจากไกล ขณะ Rotfruit Pod ระเบิดบีบพื้นที่',dur:55,interval:1.14,batch:3,max:46,pressureCap:0.56,types:['tank','siege','shooter','shooter','bomber','basic']},
      {name:'ฤดูกาลแตกสลาย',desc:'พืชกลายพันธุ์ทุกวรรณะเบ่งบานก่อน Rootmother ตื่น',dur:59,interval:0.82,batch:4,max:62,pressureCap:0.70,types:['fast','dasher','shooter','bomber','tank','siege','basic','basic']}
    ];return canopy[w]||canopy[canopy.length-1];}
    if(si===4){const crown=[
      {name:'เศษเสี้ยวสุญญะ',desc:'Void Crumb ลอยจากโต๊ะงานเลี้ยงและเริ่มกลืนเศษรสชาติ',dur:50,interval:1.48,batch:2,max:28,pressureCap:0.20,types:['basic','basic','basic','basic','basic','fast']},
      {name:'มงกุฎฉีกเงา',desc:'Crown Ripper พุ่งตัดแนวท่ามกลางฝูง Void Crumb',dur:52,interval:1.08,batch:3,max:40,pressureCap:0.34,types:['fast','fast','dasher','basic','basic']},
      {name:'เพชฌฆาตงานเลี้ยง',desc:'Banquet Executioner นำกองทัพมงกุฎเข้าปิดประตูเตา',dur:0,interval:1.40,batch:2,max:32,pressureCap:0.40,types:['basic','basic','fast','fast']},
      {name:'เนตรงานเลี้ยง',desc:'Banquet Eye ยิงจากแนวหลัง ขณะ Maw Truffle บีบพื้นที่',dur:54,interval:1.24,batch:3,max:42,pressureCap:0.52,types:['tank','siege','shooter','shooter','bomber','basic']},
  ...
  playWaveCutscene(w,beat,done){
    if(this._inTutorial){done();return;}   // ระหว่างสอน = ไม่เล่นบทพูดกับตัวเอง (กันซ้อนกับบับเบิลครูเบอร์รี่)
  ...
  playStoryPanel(key,kicker,title,body,done){
    ...
    const skip=this.add.text(w-18,h-18,'แตะเพื่อไปต่อ  ▶',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'10px',color:'#ffe08a'}).setOrigin(1,1);layer.add([art,dim,band,k,t,b,skip]);
  ...
  spawnElite(){
    ...
    e.baseScale=this.stageIndex===0?0.95:(this.stageIndex===1?0.84:this.stageIndex===2?0.92:this.stageIndex===3?0.94:this.stageIndex===4?0.56:this.stageIndex===5?0.42:1.55);if(this.stageIndex===4)e.roleName='ราชองครักษ์เตามงกุฎ';if(this.stageIndex===5)e.roleName='ต้นกล้ามงกุฎ'; e._sqX=1; e._sqY=1; e.setScale(e.baseScale).clearTint();if(e.tintColor)e.setTint(e.tintColor);if(this.anims.exists(eliteKey+'_walk'))e.play(eliteKey+'_walk',true);this.camWorld(e);return e;
  }
  ...
  setupWaveObjective(w,p){
    ...
    if(this.stageIndex>4)return;   // รอบแรกเปิดใช้กับ Chapter 1 ตามลำดับงาน
    ...
    if(type==='survive')o.target=Math.max(1,p.dur||48);
      ...
      o.target=2+(w>=4?1:0)+(this.stageIndex>=3?1:0);o.desc='กำจัด Elite ตราเป้าหมาย '+o.target+' ตัวก่อนหมดเวลา';this.spawnObjectiveElite();
    }else if(type==='purge'){
      o.target=3+(w>=4?1:0);o.desc='โจมตีหรือเข้าใกล้เพื่อชำระล้างแกน '+o.target+' จุด';for(let i=0;i<o.target;i++)this.spawnWaveObjectiveNode(i,o.target);
    }else{
      o.target=12+w*2;o.desc='ยืนในวงพลังรวม '+o.target+' วินาที';this.spawnCaptureZone();
    }
  ...
  renderWaveObjectiveHUD(){
    ...
    const frac=Phaser.Math.Clamp(o.progress/Math.max(1,o.target),0,1),value=o.type==='survive'?Math.ceil(Math.max(0,this.waveTimer))+' วิ':o.type==='capture'?o.progress.toFixed(1)+' / '+o.target+' วิ':Math.floor(o.progress)+' / '+o.target;
  ...
  completeWaveObjective(){
    ...
    const title='✅ ภารกิจสำเร็จ · Sugar +'+bonus;this.clearWaveObjective();this.mode='waveclear';this.waveTimer=0;this.showBanner(title,'กำจัดศัตรูที่เหลือเพื่อไปเวฟถัดไป',1500);Sfx.clear();
  }
  failWaveObjective(){
    const o=this.waveObjective;if(!o||o.done)return;o.done=true;this.clearWaveObjective();this.mode='waveclear';this.waveTimer=0;this.showBanner('⌛ ภารกิจหมดเวลา','ไม่ได้โบนัส แต่ยังไปต่อได้—กำจัดศัตรูที่เหลือ',1700);
  }
  clearWaveObjective(){
  ...
  tickStage(dt){
    if(this._inTutorial)return;   // freeze เวลาระหว่างสอน — ไม่สปอน ไม่นับเวลา ไม่ขึ้นเวฟ (สนามควบคุมโดย coach)
    if(this.mode==='wave'){
      this.waveTimer-=dt;
      ...
      if(this.waveTimer<=0){
        ...
        else{this.mode='waveclear';this.showBanner('⏳ หมดเวลา!','กำจัดศัตรูที่เหลือให้หมดเพื่อไปเวฟถัดไป',1800);}
  ...
  // ผ่อนความยากให้ผู้เล่นใหม่: ด่าน 1 + ช่วงต้นด่าน (ฆ่ายังน้อย) + ยังไม่จบ tutorial → มอนเลือดน้อยลง (แก้ feedback "ตีเกือบ 4 ครั้ง/ตัว")
  ...
  spawnMiniBoss(){
    ...
    if(this.state!=='play')return;
    const st=STAGES[this.stageIndex];
    this.showBanner('💢 มินิบอส!', st.mini, 2000); Sfx.bossWarn(); Sfx.bgmIntense(true); this.screenShake(200,0.008);
  ...
  spawnFinalBoss(){
    ...
    this.bossIntro(b, this.secretBoss?'The Echo of Hunger · เงาผู้กลืนรส':st.boss);
  }
  ...
  bossIntro(b,name){
    ...
    if(this.stageIndex!==0){
      ...
      this.time.delayedCall(3000,()=>cam.pan(px,py,760,'Sine.easeInOut'));this.time.delayedCall(3800,()=>{if(!b.active)return;cam.startFollow(this.player,false,0.2,0.2);if(b.body)b.body.enable=true;b.setScale(base);const idle=b.texture.key+'_idle';if(this.anims.exists(idle))b.play(idle,true);this.state='play';this.mode='boss';b.atkCd=1.6;this.spawnBossEscorts(2);this.showBanner(this.stageIndex===2?'🔥 เครื่องจักรเดินเต็มกำลัง':this.stageIndex===5?'🌿 รากแรกตื่นเต็มร่าง':'❄️ ผนึกคุกเย็นทำงาน',this.stageIndex===2?'อ่านแนวสายพานและออกจากกางเขนเตาหลอม!':this.stageIndex===5?'อ่านแนวรากสีเขียวและช่องว่างระหว่างกลีบพิษ!':'หาช่องในกรงน้ำแข็งและอย่าถอยตรงแนวพัด!',2100);});return;
    }
  ...
  onBossDown(x,y){
    ...
    this.time.delayedCall(500,()=>this.showStageChestChoice(canUnlock?('ปลดล็อกด่าน '+(next+1)):'เลือกโชคชะตาของรางวัล'));
  }
  showStageChestChoice(note){
    ...
    const w=this.W,h=this.H,portrait=w<=h,bg=this.add.rectangle(0,0,w,h,0x090611,0.94).setOrigin(0),title=this.add.text(w/2,h*0.13,'เลือกกล่องรางวัล 1 ใบ',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'24px',color:'#ffe08a'}).setOrigin(0.5),sub=this.add.text(w/2,h*0.19,note,{fontFamily:'sans-serif',fontSize:'11px',color:'#cfc3dc'}).setOrigin(0.5);this.over.add([bg,title,sub]);
    const choices=[['sugar','🍬','กล่อง Sugar','ได้เงินแน่นอน · จำนวนมาก',0xffa952],['gear','🛡️','กล่อง Gear','โอกาสอุปกรณ์สูง',0x6ed7df],['fortune','✨','กล่อง Fortune','ลุ้น Gear หรือ Sugar แจ็กพอต',0xd58cff]],gap=portrait?10:14,cols=portrait?1:3,cw=portrait?Math.min(w-40,360):Math.min(220,(w-48-gap*2)/3),ch=portrait?Math.min(118,(h*0.67-gap*2)/3):Math.min(230,h*0.55),total=cw*cols+gap*(cols-1),x0=(w-total)/2,y0=portrait?h*0.25:h*0.29;
  ...
  chooseStageChest(kind){
    if(this.state!=='rewardChoice')return;this._rewardBtns=[];this._stageReward=this.rollStageReward(kind);Sfx.clear();this.over.removeAll(true);const w=this.W,h=this.H,bg=this.add.rectangle(0,0,w,h,0x090611,0.96).setOrigin(0),glow=this.add.image(w/2,h*0.43,'vfx_glow').setTint(0xffd166).setScale(1.4).setAlpha(0.45),em=this.add.text(w/2,h*0.40,this._stageReward.emoji,{fontSize:'86px'}).setOrigin(0.5),t=this.add.text(w/2,h*0.57,'เปิดกล่องสำเร็จ!',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'23px',color:'#ffe08a'}).setOrigin(0.5),d=this.add.text(w/2,h*0.64,this._stageReward.label,{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'15px',color:'#ffffff',align:'center',wordWrap:{width:w-40}}).setOrigin(0.5);this.over.add([bg,glow,em,t,d]);this.screenFlash(0xffd166,0.35,350);this.time.delayedCall(1250,()=>{if(this.state==='rewardChoice'){this.over.setVisible(false);this.onStageClear();}});
  }
  ...
  victory(){
    ...
    const ch2=this.stageIndex===5,t=this.add.text(w/2,h*0.37,ch2?'พิชิตเรือนยอดแรก!':'ชนะแล้ว! คำสาปถูกทำลาย',{fontFamily:'sans-serif',fontStyle:'bold',fontSize:'26px',color:'#ffd166',align:'center',wordWrap:{width:w*0.85}}).setOrigin(0.5);
    const lore=this.add.text(w/2,h*0.47,ch2?'Rootmother ถอนรากหนีลงสู่สวนชั้นลึก ทิ้งคำเตือนว่าเมล็ดมงกุฎยังมีอีกสี่เมล็ด—เส้นทาง Chapter 2 เพิ่งเริ่มต้น 🌿':'The Great Hunger พังทลาย รสชาติและความทรงจำกลับคืนสู่ครัวใหญ่แล้ว 🍡',{fontFamily:'sans-serif',fontSize:'14px',color:'#c7bdd6',align:'center',wordWrap:{width:w*0.82}}).setOrigin(0.5);
    const mm=Math.floor(this.elapsed/60), ss=Math.floor(this.elapsed%60);
  ...
  rollUpgrades(n,opts){
    ...
    if(survivalPool.length && !out.some(o=>o.pas||o.type==='heal')){
      ...
      else out[out.length-1]=survivalPool[0];   // ทุกชุดมีทางเลือกเอาตัวรอดอย่างน้อย 1 ใบ
    }
  ...
  spawnEnemy(type,angOverride,radOverride){
    ...
    if(this.stageIndex===3){const role={basic:['วิญญาณน้ำตาลเยือก',0.62,24,40,46],fast:['เศษน้ำแข็งพุ่ง',0.58,20,44,50],dasher:['เศษน้ำแข็งพุ่ง',0.58,20,44,50],shooter:['ป้อมไซรัปเย็น',0.66,24,40,45],bomber:['ฟองแรงดันเยือก',0.68,27,37,41],tank:['ผู้คุมประตูเยือกแข็ง',0.80,36,28,36],siege:['ผู้คุมประตูเยือกแข็ง',0.92,36,28,36]}[type]||['วิญญาณน้ำตาลเยือก',0.62,24,40,46];
      e.roleName=role[0];e.tintColor=null;scale=role[1];e.clearTint();e.setCircle(role[2],role[3],role[4]);}
    if(this.stageIndex===4){const role={basic:['เศษเสี้ยวสุญญะ',0.36,45,83,83],fast:['อสูรมงกุฎฉีก',0.34,42,86,86],dasher:['อสูรมงกุฎฉีก',0.34,42,86,86],shooter:['เนตรงานเลี้ยง',0.38,45,83,83],bomber:['ทรัฟเฟิลปากระเบิด',0.40,46,82,82],tank:['ราชองครักษ์เตามงกุฎ',0.48,54,74,74],siege:['ราชองครักษ์เตามงกุฎ',0.56,54,74,74]}[type]||['เศษเสี้ยวสุญญะ',0.36,45,83,83];
      e.roleName=role[0];e.tintColor=null;scale=role[1];e.clearTint();e.setCircle(role[2],role[3],role[4]);}
    if(this.stageIndex===5){const role={basic:['ต้นอ่อนหมัก',0.38,45,83,83],fast:['นักล่าเถาวัลย์',0.38,43,85,85],dasher:['นักล่าเถาวัลย์',0.38,43,85,85],shooter:['โคมสปอร์',0.40,44,84,84],bomber:['ฝักผลไม้เน่า',0.42,47,81,81],tank:['ด้วงหลังราก',0.48,53,75,75],siege:['ผู้พยากรณ์หนาม',0.48,50,78,78]}[type]||['ต้นอ่อนหมัก',0.38,45,83,83];
      e.roleName=role[0];e.tintColor=null;scale=role[1];e.clearTint();e.setCircle(role[2],role[3],role[4]);}
  ...
  tickCharSignature(dt){
    ...
    // ❄️ Mint — Frost Lance เป็น Basic Attack แล้ว (ยิงเป็นจังหวะใน castSkill) · signature นี้แค่ดูแล "สายธารน้ำแข็ง" ที่หอกทิ้งไว้
  ...
  // ---- ของสวมใส่ดรอป: rarity ตามด่าน ความยาก และชนิดศัตรู ----
  ...
  openMiniSkillChest(){
    ...
    this.showBanner('🎁 กล่องมินิบอส · อัป '+chosen.length+' สกิล',names,3000);this.vfxLevelUp();
  }
  ...
  hurtPlayer(dmg,ix){ if(this.state!=='play'||this.player.iframe>0)return;
    if(this._inTutorial)return;   // ระหว่างสอน = อมตะ (freeze safe zone) ผู้เล่นใหม่จะได้ไม่ตายตอนเรียน
  ...
  chiliBossAttack(b){
    ...
    if(pick==='belt'){this.stageBossPose(b,4,900);const a=Math.atan2(py-b.y,px-b.x),len=Math.max(430,this.dist(b.x,b.y,px,py)+120),line=this.camWorld(this.add.image(b.x,b.y,'vfx_line').setOrigin(0,0.5).setRotation(a).setScale(len/256,0.62).setTint(0xffb14a).setDepth(4));this.showBanner('🔥 สายพานพุ่งชน','หลบออกจากแนวส้มก่อนเตาปิ้งพุ่ง!',780);this.tweens.add({targets:line,alpha:{from:.25,to:1},duration:120,yoyo:true,repeat:3,onComplete:()=>line.destroy()});this.time.delayedCall(560,()=>{if(b.active){b.setVelocity(Math.cos(a)*690,Math.sin(a)*690);b.knock=.52;this.screenShake(240,.009);}});b.atkCd=2.35*fast;}
    else if(pick==='pepper'){this.stageBossPose(b,3,900);this.showBanner('🌶️ ฝนพริกเพลิง','อย่าวิ่งเป็นเส้นตรง—วงร้อนจะตามตำแหน่ง!',820);for(let i=0;i<(b.phase3?9:b.phase2?7:5);i++)this.time.delayedCall(i*125,()=>{if(b.active&&this.state==='play')this.spawnHazard(this.player.x+Phaser.Math.Between(-105,105),this.player.y+Phaser.Math.Between(-105,105),56,d,0xff5a38);});b.atkCd=2.75*fast;}
    else if(pick==='gears'){this.stageBossPose(b,5,950);this.showBanner('⚙️ เฟืองบดรส','ลอดช่องว่างระหว่างใบมีดหมุน!',820);const n=b.phase3?18:b.phase2?14:11,gap=Phaser.Math.Between(0,n-1);for(let i=0;i<n;i++){if(i===gap||i===(gap+1)%n)continue;this.foeShot(b.x,b.y,i*TAU/n,190+(i%2)*48,d,0xffb04f,1.05);}b.atkCd=2.45*fast;}
    else{this.stageBossPose(b,2,1100);this.showBanner('♨️ เตาหลอมโอเวอร์ฮีต','ออกจากกางเขน แล้วข้ามคลื่นไฟ!',930);for(const rot of [0,Math.PI/2]){const mark=this.camWorld(this.add.image(px,py,'vfx_line').setRotation(rot).setScale(4.2,.72).setTint(0xff4938).setAlpha(.72).setDepth(3));this.tweens.add({targets:mark,alpha:{from:.22,to:1},duration:130,yoyo:true,repeat:4,onComplete:()=>mark.destroy()});}this.time.delayedCall(720,()=>{if(!b.active)return;for(let i=-3;i<=3;i++){if(i===0)continue;this.spawnHazard(px+i*88,py,49,d,0xff4938);this.spawnHazard(px,py+i*88,49,d,0xff4938);}this.bossNovaWave(b.x,b.y,285,d+4,320);});b.atkCd=3.15*fast;}
  }
  frostBossAttack(b){
    ...
    if(pick==='bars'){this.stageBossPose(b,5,1050);this.showBanner('🔒 กรงน้ำแข็งปิดตาย','หาช่องว่างหนึ่งช่องก่อนผนึกกระแทก!',900);const gap=Phaser.Math.Between(-2,2);for(let i=-3;i<=3;i++){if(i===gap)continue;const x=px+i*78,mark=this.camWorld(this.add.image(x,py,'vfx_line').setRotation(Math.PI/2).setScale(3.8,.52).setTint(0x8fe7ff).setAlpha(.70).setDepth(3));this.tweens.add({targets:mark,alpha:{from:.22,to:1},duration:140,yoyo:true,repeat:4,onComplete:()=>mark.destroy()});this.time.delayedCall(760,()=>{if(b.active)this.spawnHazard(x,py,45,d,0x83ddff);});}b.atkCd=3.0*fast;}
    else if(pick==='shards'){this.stageBossPose(b,3,850);const base=Math.atan2(py-b.y,px-b.x),shots=b.phase3?11:b.phase2?9:7;this.showBanner('❄️ พัดเศษน้ำแข็ง','วิ่งตัดมุมพัด อย่าถอยตรง ๆ!',760);this.time.delayedCall(360,()=>{if(!b.active)return;for(let i=0;i<shots;i++)this.foeShot(b.x,b.y,base+(i-(shots-1)/2)*.14,245,d,0x9fe8ff,1.0);});b.atkCd=2.15*fast;}
    else if(pick==='blizzard'){this.stageBossPose(b,6,1100);this.showBanner('🌨️ พายุคุกเย็น','แรงลมดึงเข้าศูนย์กลาง—วิ่งออกด้านข้าง!',900);this.drainPull={x:b.x,y:b.y,t:b.phase3?2.1:1.55,strength:b.phase3?170:135};this.moveSlowT=Math.max(this.moveSlowT||0,1.1);for(let i=0;i<3;i++)this.bossNovaWave(b.x,b.y,210+i*58,d,250+i*360);b.atkCd=3.25*fast;}
    else{this.stageBossPose(b,2,980);this.showBanner('🧊 ค้อนทลายธาร','วงกระแทกสามจังหวะ—สลับเข้าออก!',850);for(let i=0;i<(b.phase3?3:2);i++)this.time.delayedCall(300+i*430,()=>{if(b.active)this.bossNovaWave(b.x,b.y,230+i*55,d+3,0);});b.atkCd=2.85*fast;}
  }
  ...
  bossThink(b,dt){
    ...
    if(b.isBoss && !b.phase3 && b.hp<=b.maxhp*phase3At){ b.phase3=true; this.beginBossPhaseTransition(b,1.8,this.stageIndex===1?0x66d8ff:0xd95cff); b.spd*=1.2; b.atkCd=0.4;
      ...
      this.showBanner(this.stageIndex===0?'👑 เฟส 3 · ราชินีคลั่ง':this.stageIndex===1?'🌊 เฟส 3 · ท่อล้น':this.stageIndex===2?'🌋 เฟส 3 · เตาหลอมแตก':this.stageIndex===3?'🌨️ เฟส 3 · พายุคุกเย็น':this.stageIndex===5?'🌺 เฟส 3 · Full Bloom':'💢 คลั่งสุดขีด!',this.stageIndex===0?'กองเพาะเปิด—ฝูงมดจะบุกไม่หยุด!':this.stageIndex===1?'คลื่นฟองซ้อนสองชั้น—อย่าหยุดเคลื่อนที่!':this.stageIndex===2?'กางเขนไฟและเฟืองบดทำงานพร้อมกัน!':this.stageIndex===3?'กรง พัดน้ำแข็ง และพายุจะซ้อนจังหวะ!':this.stageIndex===5?'กลีบพิษบานเต็มฟ้า—ทำลายเมล็ดมงกุฎก่อนรากกลืนครัว!':'เฟสสุดท้าย — ระวังให้ดี!',1800); this.screenShake(520,0.016); this.screenFlash(this.stageIndex===1||this.stageIndex===3?0x66d8ff:this.stageIndex===5?0xd95cff:0xff2d4a,0.4,500);
